...
const contributors = [
  ...
  ["Sushobhan Biswas",   "Testing & Deployment Lead",     "Handled end-to-end testing of the analysis pipeline across 12 functional test cases, managed Railway and Vercel deployment configuration, environment variable setup, and coordinated the migration to HuggingFace Spaces.", "https://github.com/sushobhanBiswas", "https://linkedin.com/in/sushobhan-biswas-65991930b"],
  ["Arghyodeep Samanta", "Frontend Lead",     "Built and maintained the React single-page frontend — landing page, resume upload flow, result rendering with score ring and skill chips, authentication pages, score history dashboard, and job suggestions UI.", "https://github.com/Arghyadeep22", "https://www.linkedin.com/in/arghyadeep-samanta-ab4bba402?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"],
  ["Sovan Lal Ganguly",  "UI/UX Designer",     "Designed the visual identity of ResumePilot — color palette, typography, layout system, landing page hero artwork, and the overall dark-themed aesthetic used consistently across all pages and components.", "https://github.com/sovanlalganguly369-alt", "https://www.linkedin.com/in/sovanlal-ganguly-20914125a?utm_source=share_via&utm_content=profile&utm_medium=member_android"],
];
